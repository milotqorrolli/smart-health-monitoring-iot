...
| Spark Streaming | `spark/streaming_job.py` reads Kafka streams, enriches vitals with time-windowed joins to the other sensor streams, applies rule and ML inference, prepares alerts, stores sensor metadata, and writes aggregate windows. |
